...
//Строка 5 - использовал длину массива "arreyResault.length" вместо зачения "3" - мне кажется, что так более универсальней. При добавлении в массив новых данных, не нужно будет менять значение "3"